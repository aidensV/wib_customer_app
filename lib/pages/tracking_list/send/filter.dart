                ...
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: DateTimeField(
                      ...
                      initialValue: widget.tanggalawaldelivered == 'kosong' ? DateTime.now() : DateTime.parse(_tanggalawalvalue),
                      ...
                      onShowPicker: (context, currentValue) {
                        return showDatePicker(
                          ...
                          context: context,
                          initialDate: widget.tanggalawaldelivered == 'kosong' ? DateTime.now() : DateTime.parse(_tanggalawalvalue),
                ...
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: DateTimeField(
                      readOnly: true,
                      format : DateFormat('dd-MM-yyy'),
                      initialValue: widget.tanggalakhirdelivered == 'kosong' ? DateTime.now() : DateTime.parse(_tanggalakhirvalue),
                      decoration: InputDecoration(
                      ...
                      onShowPicker: (context, currentValue) {
                        return showDatePicker(
                          firstDate: DateTime(1900),
                          context: context,
                          initialDate: widget.tanggalakhirdelivered == 'kosong' ? DateTime.now() : DateTime.parse(_tanggalakhirvalue),
                          lastDate: DateTime(2100));
                        },
                        onChanged: (ini) {
                        setState(() {
